...
// ar is the array intialized in the main function.
// ar_count is the number of elements to be stored in the array ar.
 
long aVeryBigSum(int ar_count, long* ar) {
    int i;              //initializing i as integer for for-loop
    long result;    //intializing result as long. As, it has 8 byte storage size
...
//the code below is already given in HackerRank, we are using their format for coding
int main()
{
