 ...
 * ar is the array. 
 * ar_count is the total elements in the array ar.
 *
 */
int simpleArraySum(int ar_count, int* ar) { 
 
   int i,result=0;            //initializing i and result as integer. i is used for for-loop and result at first initialized as 0 for summation of element in the array  
...
//the code below is already mention in HackerRank
int main()
{
